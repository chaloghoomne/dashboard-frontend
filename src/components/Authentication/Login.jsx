  ...
  return (
    <div className="w-full h-full flex justify-center items-center">
      <div className="w-[35%] h-[80%] p-5 bg-white/20 rounded-[100px]">
        ...
        className="w-full bg-no-repeat bg-cover h-full p-5 gap-2  bg-white rounded-[100px] justify-center items-center flex flex-col">
          <img  src={logo} className="pb-10  w-28" alt="" />
          ...
          <div className="flex relative bg-white rounded-lg  border border-[#9D9D9D] flex-col w-[90%] ">
          <input
          ...
          <div onClick={()=>setShow(!show)} className="absolute cursor-pointer right-3 top-2">
           ...
           {error.password && <p className="text-red-500 w-[90%] items-start flex justify-start relative bottom-1">{error.password}</p>}
          <p
            className="text-[#3180CA] relative right-5 text-end self-end cursor-pointer opacity-[100%] text-md z-[2]"
            style={{ opacity: "100%" }}
          ...
          <button
            className="bg-[#3180CA] mt-4 rounded-lg text-white p-2 w-[70%]"
