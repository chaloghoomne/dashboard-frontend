  ...
  return (
   <div className="w-full h-full flex justify-center items-center" >
    ...
    <div  className=" w-full h-full p-5 gap-2 bg-white rounded-[100px] justify-center items-center flex flex-col">
      ...
      <p className="text-[#FC6011] font-medium text-3xl mb-1">OTP VERIFICATION</p>
      <p className="text-[#FC6011] text-lg mb-2 ">Hope You Are Doing Well!</p>
      <OTPInput length={4} title={"Email"} 
      method={'PUT'}
